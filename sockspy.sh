...
cd socks
patch="https://raw.githubusercontent.com/VPSARG/VPS-ARG-2.0/master/ArchivosUtilitarios/backsocz"
arq="backsocz"
...
cd $HOME
msg="$2"
[[ $msg = "" ]] && msg="@Pablo_Ezekiel"
portxz="$1"
[[ $portxz = "" ]] && portxz="8080"
screen -dmS sokz scktcheck "$portxz" "$msg" > /dev/null 2>&1
}
gettunel_fun () {
echo "master=VPSPACK PLUS-Argento" > ${SCPinst}/pwd.pwd
...
screen -dmS getpy python ${SCPinst}/PGet.py -b "0.0.0.0:$1" -p "${SCPinst}/pwd.pwd"
 ...
 echo -e "$(fun_trans  "Gettunel Iniciado con exito")"
 echo -ne "$(fun_trans  "Su contraseña de Gettunel"):"
 echo -e "\033[1;32m Argento-Vps™"
 } || echo -e "$(fun_trans  "Gettunel no ha comenzado")"
}

PythonDic_fun () {
echo -e "\033[1;97mSelecciona Puerto del SOCKS\033[1;37m" 
echo -ne "Ahora digite un puerto SSH/DROPBEAR activo: \033[1;37m" && read puetoantla 
(
...
RESPONSE = 'HTTP/1.1 200 <strong>$texto_soket</strong>\r\nContent-length: 0\r\n\r\nHTTP/1.1 200 ok BIGsocks\r\n\r\n'
#RESPONSE = 'HTTP/1.1 200 internet ilimitado\r\nContent-length: 0\r\n\r\nHTTP/1.1 200 Connection established\r\n\r\n'  # lint:ok
...
echo -e "\033[1;32m $(fun_trans  "INSTALADOR SOCKS By 🇦🇷 ARGENTO 🇦🇷")"
...
echo -e "${cor[4]} [7] > \033[1;36m$(fun_trans  "Detener TODOS SOCKS PYTHON")"
